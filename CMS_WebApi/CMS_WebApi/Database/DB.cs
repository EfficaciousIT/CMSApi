...
namespace CMS_WebApi.Database
{
    public class DB
    {
        ...
        public DataSet SchoolDetails(string command)
        {
            using (SqlConnection con = new SqlConnection(constr))
            {
                try
        ...
        public DataSet DashboardDetails(string command, Dashboard dashboard)
        {
            using (SqlConnection con = new SqlConnection(constr))
            {
                try
                {
                    ...
                    else if(command == "NoticeBoardTeacher" || command == "NoticeBoardStaff")
                    {
                        com.Parameters.AddWithValue("@type", command);
                        //com.Parameters.AddWithValue("@AcademicID", dashboard.intAcademic_id);
                        com.Parameters.AddWithValue("@SchoolId", dashboard.intSchool_id);
        ...
        public DataSet AttendanceDetail(string command, Attendance attendance)
        {
            using (SqlConnection con = new SqlConnection(constr))
            {
                ...
                {
                    String query = "";
                    if (command == "BackDate" || command == "BackDateTeacher" || command == "BackDateTeacherBYPrincipal")
                    {
                    ...
                    else if (command == "BackDateTeacher")
                    {
                        com.Parameters.AddWithValue("@command", command);
                        com.Parameters.AddWithValue("@dtDate", attendance.dtDate);
                        com.Parameters.AddWithValue("@intschool_id", attendance.intSchool_id);
        ...
        public DataSet LibraryData(string command, Library library)
        {
            using (SqlConnection con = new SqlConnection(constr))
            {
                ...
                {
                    String query = "";
                    if (command == "GetCategoryWiseData" || command == "GetStandardWiseBookList" || command == "GetBookList" || command == "GetStandardWiseAdminBookList" || command == "GetCategoryWiseDataForAdmin")
                    {
                        query = "usp_BookDetails";
                    }
                    else if (command == "AssignBookDetails" || command == "TeacherAssignBookDetails" || command == "TeacherReturnBookDetails" || command == "ReturenBookDetails")
                    {
                    ...
                    if (command == "GetCategoryWiseData" || command == "GetStandardWiseAdminBookList" || command == "GetCategoryWiseDataForAdmin")
                    {
                    ...
                    else if (command == "AssignBookDetails" || command == "ReturenBookDetails")
                    {
                        com.Parameters.AddWithValue("@intstandard_id", library.intStandard_id);
                        com.Parameters.AddWithValue("@intStudent_id", library.intStudent_id);
                    ...
                    else if (command == "TeacherAssignBookDetails" || command == "TeacherReturnBookDetails")
                    {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                try
                {
                    ...
                    if (command == "insert")
                    {
                        ...
                        {
                            SqlString = "select vchFCMToken from Student_Master where vchFCMToken IS NOT NULL and vchFCMToken<>'' and  intSchool_id='" + noticeboard.intSchool_id + "' ";
                        ...
                        {
                            SqlString = "select vchFCMToken from tblTeacher_Master where vchFCMToken IS NOT NULL and vchFCMToken<>'' and  intSchool_id='" + noticeboard.intSchool_id + "' ";

                        }
                        else if (noticeboard.intUserType_id == 5)
                        {
                            SqlString = "select vchFCMToken from tblAdmin_Master where vchFCMToken IS NOT NULL and vchFCMToken<>'' and  intSchool_id='" + noticeboard.intSchool_id + "'";
                        }
                        //else if (noticeboard.intUserType_id == 0)
                        //{
                        //    SqlString = "select vchFCMToken from Student_Master where vchFCMToken IS NOT NULL and vchFCMToken<>'' and  intSchool_id='" + noticeboard.intSchool_id + "' "
                        //               + "select vchFCMToken from tblTeacher_Master where vchFCMToken IS NOT NULL and vchFCMToken<>'' and  intSchool_id='" + noticeboard.intSchool_id + "' "
                        //               + "select vchFCMToken from tblAdmin_Master where vchFCMToken IS NOT NULL and vchFCMToken<>'' and  intSchool_id='" + noticeboard.intSchool_id + "'";
        ...
        public DataSet GalleryDetail(string extension, string EventDescription)
        {
            using (SqlConnection con = new SqlConnection(constr))
            {
                try
